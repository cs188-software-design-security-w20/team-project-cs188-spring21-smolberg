...
import { Flex, Text, Box, Button, Card, IconButton } from '@theme-ui/components'
...
const HIWCard = () => {
    ...
    return (
        <Card p={3} sx={{ width: "700px", height: "400px" }}>
            <Flex sx={{ height: "100%", alignItems: "center", flexDirection: "column", justifyContent: "space-between", textAlign: "center" }}>
                ...
                <Flex mt={3} sx={{ width: "20%", justifyContent: "space-evenly" }}>
                    ...
                    <PageIndicatorButton active={currentPage === 2} onClick={() => setCurrentPage(2)} />
                    <PageIndicatorButton active={currentPage === 3} onClick={() => setCurrentPage(3)} />
                    <PageIndicatorButton active={currentPage === 4} onClick={() => setCurrentPage(4)} />
                </Flex>
            </Flex>
        </Card>
    )
        ...
        <Container>
            <Flex sx={{ flexDirection: "column", alignItems: "center" }}>
                <Flex sx={{ flexDirection: "column" }}>
                    <Text mt={4} sx={{ fontSize: [70, 70, 70, 70, 90] }}>Take back control of your data.</Text>
                    <Flex mt={4} sx={{ justifyContent: "flex-start", flexDirection: ["column", "row"] }}>
                        <Box sx={{ flexShrink: "0" }}>
                    ...
                    <Text mt={5} sx={{ fontSize: [50, 50, 50, 50, 70] }}>How this works</Text>
