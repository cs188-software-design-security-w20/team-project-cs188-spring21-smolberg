...
export default function Header() {
  ...
  const themeNames = ["light", "dark", "deep", "swiss"];
  ...
  return (
    <Box
      bg="background"
      sx={{ height: "80px", width: "100%", alignItems: "center" }}
      css={{ position: "sticky", top: "0", zIndex: "9999" }}
    >
      <Flex
        bg="background"
        sx={{
      ...
      >
        <Flex>
          <RouterLink
            to="/"
            sx={{ variant: "styles.h2", textDecoration: "none", color: "text" }}
            css={{ cursor: "pointer" }}
          >
            {constants.APP_NAME}
          </RouterLink>
